...
class LLAMA_INDEX():
    ...
    def initialize_qdrant(self):
        ...
        # Temporarily clear proxy settings to avoid conflicts with Tusk Drift's proxy during replay
        # This allows httpx (used by qdrant_client) to initialize without proxy errors
        saved_proxies = {}
        ...
        try:
            client = qdrant_client.QdrantClient(qdrant_url, grpc_port=6334, prefer_grpc=True)
            return client
        finally:
